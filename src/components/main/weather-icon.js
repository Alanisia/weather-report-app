...
export default {
  _weather: [
    ...
    {name: "大雨", icon: <svgs.SvgIcon svg={svgs.svgs.cloudRainFill}/>},
    {name: "大到暴雨", icon: <svgs.SvgIcon svg={svgs.svgs.cloudRainHeavy}/>},
    {name: "暴雨", icon: <svgs.SvgIcon svg={svgs.svgs.cloudRainHeavyFill}/>},
